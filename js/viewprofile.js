...
function mailMe() {
    console.log(document.getElementById("mailadres").value);
    var mail = document.getElementById("mailadres").value;
    var link = 'mailto:' + mail + '?subject=Message from ' + '&body=' + document.getElementById('bericht').value;
